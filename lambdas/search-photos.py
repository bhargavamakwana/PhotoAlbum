...
ES_HOST = 'https://search-photos-s2jfh5xpge7nleokbrq2kn4r5m.us-east-1.es.amazonaws.com/photos/_search?q='
REGION = 'us-east-1a'
S3_URL = 'https://s3.amazonaws.com/b2rekog/'
def get_url(keyword):
...
def lambda_handler(event, context):
	...
	for i, tag in slots.items():
		if tag:
			...
			es_response = requests.get(url, headers=headers, auth=("Cloud","Nobel@0399")).json()
